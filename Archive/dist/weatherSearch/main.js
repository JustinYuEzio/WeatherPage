...
let FavourateComponent = class FavourateComponent {
...
FavourateComponent.ctorParameters = () => [
...
let HourlyComponent = class HourlyComponent {
    ...
    showChart_temp() {
        ...
        setTimeout(() => {
            this.chart = new _node_modules_chart_js__WEBPACK_IMPORTED_MODULE_2__["Chart"]("chart", {
                type: 'bar',
                data: {
...
let SearchFormComponent = class SearchFormComponent {
    constructor(http) {
        ...
        this.auto_url = "http://weathersearch-env.eba-vmsvqibd.us-west-1.elasticbeanstalk.com/auto_complete";
        this.location_url = "http://weathersearch-env.eba-vmsvqibd.us-west-1.elasticbeanstalk.com/location";
        this.weather_url = "http://weathersearch-env.eba-vmsvqibd.us-west-1.elasticbeanstalk.com/weather";
        this.logo_url = "http://weathersearch-env.eba-vmsvqibd.us-west-1.elasticbeanstalk.com/logo";
        this.link = "";
        this.fav = false;
        this.res = true;
    ...
    getWeatherFromFav(msg) {
        ...
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpRequest"]('GET', this.location_url, {
            params,
            reportProgress: true
        });
            ...
            switch (event.type) {
                case _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpEventType"].Response:
                    if (event.body.results.length != 0) {
                        ...
                        console.log(params);
                        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpRequest"]('GET', this.weather_url, {
                            params,
                            reportProgress: true,
                        });
                        //console.log(req);
    ...
    getLink() {
        ...
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpRequest"]('GET', this.logo_url, { params, reportProgress: true });
        this.http.request(req).subscribe((event) => {
            switch (event.type) {
...
let WeeklyComponent = class WeeklyComponent {
    ...
    drawChart() {
        ...
        let chart = new _canvasjs_2_3_2_canvasjs_min__WEBPACK_IMPORTED_MODULE_3__["Chart"]("chartContainer", {
    ...
    getData(lat, lng, time) {
        ...
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpRequest"]('GET', this.daily_url, {
            params,
            reportProgress: true,
        });
        this.http.request(req).subscribe((event) => {
...
module.exports = __webpack_require__(/*! /Users/hengyiyu/Library/Mobile Documents/com~apple~CloudDocs/Documents/csci-571/HW/HW8/weatherSearch/src/main.ts */"./src/main.ts");
